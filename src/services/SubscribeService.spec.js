...
describe('Subscribe Service', () => {
  it('should test whether context is recived', () => {
    SubscribeService.subscribe(message);
  ...
  it.skip('should test storeStatusResult', async () => {
    const response = {};
    SubscribeService.storeSubscribeResult(response);
    expect(MessageRespository.storeResult).toBeCalled();
  });

  it('should test getSelectResult', () => {
    const messageId = {};
    SubscribeService.getSubscribeResult(messageId);
