...
describe('Select Service', () => {
  it('should test whether context is recived', () => {
    TrackService.track(selectRequest);
  ...
  it('should test storeTrackResult', async () => {
    const response = {};
    TrackService.storeTrackResult(response);
    expect(MessageRespository.storeResult).toBeCalled();
  });

  it('should test getTrackResult', () => {
    const messageId = {};
    TrackService.getTrackResult(messageId);
