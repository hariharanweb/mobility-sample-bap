...
describe('Select Service', () => {
  it('should test whether context is recived', () => {
    StatusService.status(selectRequest);
  ...
  it('should test storeStatusResult', async () => {
    const response = {};
    StatusService.storeStatusResult(response);
    expect(MessageRespository.storeResult).toBeCalled();
  });

  it('should test getSelectResult', () => {
    const messageId = {};
    StatusService.getStatusResult(messageId);
