...
beforeEach(() => {
  ...
  StatusService.getStatusResult = vi.fn();
});
...
describe('Status Controller', () => {
  it('should test status service is called', async () => {
    ...
    expect(StatusService.status).toBeCalled();
  });
  ...
  it('should test whether the getStatustResult from statusService is called', async () => {
    ...
    await StatusController.statusResult(req, res);
    expect(StatusService.getStatusResult).toBeCalled();
  });
});
